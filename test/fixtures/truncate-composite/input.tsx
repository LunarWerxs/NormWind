...
export const Truncated = () => (
    <div className="overflow-hidden text-ellipsis whitespace-nowrap block">truncate me</div>
);
...
export const StillSafe = () => (
    <div className="overflow-hidden text-ellipsis whitespace-nowrap overflow-visible">still safe</div>
);
