...
// The vendored group table is the fallback shorthand source: a loaded engine
// that supports canonicalizeCandidates(..., { collapse: true }) answers first
// (lib/engine-collapse.mjs), and the table speaks only for older engines and
// for groups the engine has not answered.
