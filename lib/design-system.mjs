...
// The vendored group table is the primary shorthand source: a loaded engine
// that supports canonicalizeCandidates(..., { collapse: true }) only adds the
// merges the table misses (lib/engine-collapse.mjs), and older engines get the
// table alone.
