...
- eslint-plugin-tailwindcss is pinned to 3.18.3 and @babel/parser to 7.29.8 - the v4/Babel-8 majors were deferred while Node 20 was supported; that reason expired when the floor moved to >=22 on 2026-09-10, so this is a known-pending migration that is now unblocked and untested rather than an oversight. anchors: `package.json:61`
