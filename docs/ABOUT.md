...
- eslint-plugin-tailwindcss is pinned to 3.18.3 and @babel/parser to 7.29.8 - the changelog says outright that the v4/Babel-8 majors are deliberately deferred while Node 20 support is maintained, so this is a known-pending migration, not an oversight. anchors: `package.json:61`
